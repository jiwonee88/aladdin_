...
?>
	...
	<div class="container main <?=$bg_type?> <?=$outer_css?$outer_css:' main_opacity '?> ">            
        <div class="header">
            <div class="header_top">           
                <div class="logo">
				<span class="NAVI-text"><a href='/'><img src="<?=G5_THEME_URL?>/new_img/logo_login.png" class="NAVI-login"></a></span>
                </div>
                <div class="menuBtn">메뉴</div>
            </div>
        </div>
