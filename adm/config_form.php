...
<tr>
<th scope="row"><label for="cf_visit_del">접속자로그 삭제</label></th>
<td><?php echo help('설정일이 지난 접속자 로그 자동 삭제') ?>
<input type="text" name="cf_visit_del" value="<?php echo $config['cf_visit_del'] ?>" id="cf_visit_del" class="frm_input" size="5">
일 </td>
<th scope="row"><label for="cf_login_minutes">현재 접속자</label></th>
<td><?php echo help('설정값 이내의 접속자를 현재 접속자로 인정') ?>
...
분 </td>
		...
		*/?>
        ...
        <tr>
            <th scope="row"><label for="cf_point_term">아이템 소각 퍼센트</label></th>
            <td colspan="3">
				포인트전환1 꽃송이 지급비율
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="cf_percent1" value="<?php echo $config['cf_percent1']; ?>" id="cf_point_term" required class="required frm_input" size="5">%<br>
				포인트전환1 쇼핑포인트 지급비율
                &nbsp;<input type="text" name="cf_percent2" value="<?php echo $config['cf_percent2']; ?>" id="cf_point_term" required class="required frm_input" size="5">%<br>
				포인트전환2 꽃송이 지급비율
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="cf_percent3" value="<?php echo $config['cf_percent3']; ?>" id="cf_point_term" required class="required frm_input" size="5">%<br>
            </td>
        </tr>
        <tr>
