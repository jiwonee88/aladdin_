        ...
        <div class="wrap">
            <div class="area area02">
                ...
                <ul class="buy sell">
				   ...
				   <li class="squareWB " style='width:32%;'><a href='/for_common/incomplete.php?stats_stx=1-1'><span class="condition"><?=$buyer_stats[cnt_stats_1]>99?'+99':($buyer_stats[cnt_stats_1]?$buyer_stats[cnt_stats_1]:0)?>건</span><span class="f_yellow" >미처리</span></a></li>
                    <li class="squareWB "  style='width:32%;'><a href='/for_common/incomplete.php?stats_stx=1-2'><span class="condition"><?=$buyer_stats[cnt_stats_2]>99?'+99':($buyer_stats[ct_stats_2]?$buyer_stats[cnt_stats_2]:0)?>건</span><span class="f_yellow">완료대기</span></a></li>
                    <li class="squareWB "  style='width:32%;'><a href='/for_common/incomplete.php?stats_stx=1-3'><span class="condition"><?=$buyer_stats[cnt_stats_4]>99?'+99':($buyer_stats[cnt_stats_3]?$buyer_stats[cnt_stats_3]:0)?>건</span><span class="f_red">완료</span></a>
                    </li>
                </ul>
				
				<h5 class='mt-3'>판매</h5>
                <ul class="buy sell">                    
				<li class="squareWB"  style='width:32%;'><a href='/for_common/incomplete.php?stats_stx=2-1'><span class="condition"><?=$seller_stats[cnt_stats_1]>99?'+99':($seller_stats[cnt_stats_1]?$seller_stats[cnt_stats_1]:0)?>건</span><span class="f_blue">미처리</span></a></li>
                    <li class="squareWB"  style='width:32%;'><a href='/for_common/incomplete.php?stats_stx=2-2'><span class="condition"><?=$seller_stats[cnt_stats_2]>99?'+99':($seller_stats[cnt_stats_2]?$seller_stats[cnt_stats_2]:0)?>건</span><span class="f_blue">완료대기</span></a></li>
                    <li class="squareWB"  style='width:32%;'><a href='/for_common/incomplete.php?stats_stx=2-3'><span class="condition"><?=$seller_stats[cnt_stats_4]>99?'+99':($seller_stats[cnt_stats_3]?$seller_stats[cnt_stats_3]:0)?>건</span><span class="f_red">완료</span></a>
                    </li>
                </ul>
            </div>
<?php
...
//구매
    ...
    $sql = " select a.*,b.mb_id bmb_id,b.mb_hp bmb_hp,b.mb_name bmb_name,b.mb_bank,b.mb_bank_num, b.mb_bank_user, b.mb_trade_paytype  {$sql_common} {$sql_search} {$sql_order} limit {$from_record}, {$rows} ";
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            <div class="area area03 item_bg_<?=$row[cn_item]?>">
				...
				<dl class="trade_basic">
					<dd style="width:50%;float:left;">
						<div class="w-95"><img src="<?=G5_THEME_URL?>/images/item/<?=$info[img]?>" alt=""></div>
					</dd>
					<dd style="width:45%;float:right;">
			...
			<li>판매자 이름 : <?=$row[mb_bank_user]!=''?$row[mb_bank_user]:$row[bmb_name]?></li>  
                ...
                <div class="storeBuy">
                    <ul>
						...
						<li>
                            <button type='button' class='btn-claim-open ml-10' data-code='<?=$row[tr_code]?>' >신고</button>
                        </li>
						<?php
                        } ?>
						<?php
                    ...
                    <li>
                            <button type='button' class='btn-deposit ml-10' data-code='<?=$row[tr_code]?>' >결제확인</button>
                        </li>
						<?php } ?>
                    </ul>
                </div>
			...
			<dl class="trade_basic">
				...
				<dd style="width:45%;float:right;">
					...
					<ul>               
						...
						<li>구매자 이름 : <?=$row[mb_bank_user]!=''?$row[mb_bank_user]:$row[bmb_name]?></li>  -->
			...
			<div class="popup popup-<?=$row[tr_code]?>">			
            	...
            	<div class="storeBuy">
					...
					<?php
                        if ($row[tr_stats]!='3') {?>
                        <li>
                            <button type='button' class='btn-complete ml-10' data-code='<?=$row[tr_code]?>' >상품전송</button>
                        </li>
						<?php } ?>
                    </ul>
                </div>
